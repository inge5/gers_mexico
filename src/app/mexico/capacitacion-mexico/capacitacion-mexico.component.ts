...
@Component({
  ...
  templateUrl: './capacitacion-mexico.component.html',
  styleUrls: ['./capacitacion-mexico.component.css']
})
export class CapacitacionMexicoComponent implements OnInit {
  ...
  asignarEventos() {
    this.capacitacionesS.getCapacitacionesMexico().subscribe((resp: any[]) => {
  ...
  getCapacitaciones(){
    let capacitacion = this.capacitaciones.filter(filtro => {
        ...
        filtro.categorias_capacitaciones.forEach(element => {
          this.capacitacionesS.getCategoriaCapacitacionesIdMexico(element).subscribe((resp: any) => {
  ...
  getCategoriasFiltro() {
    this.capacitacionesS.getCategoriaCapacitacionesMexico().subscribe((resp : any) => {
